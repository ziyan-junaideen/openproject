...
describe User, 'allowed scope' do
  ...
  describe "w/ the context being a project
    ...
    it "should return the user" do
      Authorization.users(permission: action, project: project).should == [user]
    end
  end
 ...
 describe "w/ the context being a project
    ...
    it "should return the user" do
      Authorization.users(permission: action, project: project, admin_pass: false).should == []
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should be empty" do
      Authorization.users(permission: action, project: project).should be_empty
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should return the user" do
      expect(Authorization.users(project: project)).to eq [user]
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should return the anonymous user" do
      expect(Authorization.users(permission: action, project: project)).to match_array([anonymous])
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should return the user and anonymous" do
      Authorization.users(permission: public_action, project: project).should =~ [user]
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should return the user" do
      Authorization.users(permission: [action, public_action], project: project).should =~ [user]
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should return the user" do
      Authorization.users(permission: action).should == [user]
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should be empty" do
      Authorization.users(permission: action).should be_empty
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should return the user" do
      expect(Authorization.users(permission: action)).to match_array([user])
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should be anonymous" do
      Authorization.users(permission: action).should =~ [anonymous]
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should be empty" do
      expect(Authorization.users(project: project, permission: permission.name)).to eq []
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should return the user" do
      expect(Authorization.users(project: project, permission: permission.name)).to eq [user]
    end
  end
  ...
  describe "w/ the context being a project
    ...
    it "should be empty" do
      expect(Authorization.users(project: project, permission: action)).to eq []
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should be empty" do
      expect(Authorization.users(permission: permission.name)).to eq []
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should return the user" do
      expect(Authorization.users(permission: permission.name)).to eq [user]
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should be empty" do
      expect(Authorization.users(permission: action)).to eq []
    end
  end
  ...
  describe "w/o the context being a project
    ...
    it "should return the user" do
      expect(Authorization.users(permission: action)).to eq [user]
    end
  end
end
