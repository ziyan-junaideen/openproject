...
##
# Transparently applies the 'rails_relative_url_root' to the routing table.
...
[OpenProject::Configuration["rails_relative_url_root"]].compact.each do |root|
  ...
  puts "[info] Prepending #{root} to all routes (including shallow ones) as configured through 'rails_relative_url_root'."
end
